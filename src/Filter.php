...
class Filter
{
    ...
    /**
     * 判断是否有传递某参数
     * @param int $type INPUT_GET, INPUT_POST, INPUT_COOKIE, INPUT_SERVER, or INPUT_ENV值其中一个
     ...
     * @return int
     */
    public static function getId($filtername)
    {
     ...
     * @param int $filter 指定过滤器ID
     * @param mixed $options 指定过滤器参数
     * @return mixed
     */
    public static function varVar($variable, $filter = 516, $options = null)
    {
